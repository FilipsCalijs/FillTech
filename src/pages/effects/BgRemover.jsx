...
const BgRemover = () => {
  ...
  return (
    <div className={`py-12 ${CONTAINER.blog}`}>
      ...
      <Typography variant="h2" weight="bold" className="block mb-2">{t('bgRemover.title')}</Typography>
      <Typography variant="lead" color="muted" className="block mb-10">{t('bgRemover.subtitle')}</Typography>
            ...
            {preview ? (
              ...
              <div className="flex flex-col items-center gap-4 px-8 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t('upload.jpgPngHint')}</p>
                </div>
              </div>
            )}
          ...
          >
            {loading ? (
              ...
              <>
                ...
                {file ? t('actions.removeBackground') : t('upload.uploadFirst')}
              </>
            )}
          </button>
