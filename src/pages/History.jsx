...
const History = () => {
  ...
  return (
    <div className={`py-10 ${CONTAINER.blog}`}>
      ...
      {loading ? (
        <div className="flex justify-center py-8"><svg className="animate-spin text-muted-foreground" width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeDasharray="44" strokeDashoffset="30"/></svg></div>
      ) : (
        <GenerationsTable
